    ...
    for name,f in functions_smooth.items():
        ...
        for i1 in range(nSamples):
            for i2 in range(nExp):
                ...
                tt_cores, list_n, list_intervals = adaptive_tt_offline(n,domain,samples[i1],f,tol=tol)
        ...
        tt_cores, list_n, list_intervals = adaptive_tt_offline(n,domain,nbr_samples,f,tol=tol)
